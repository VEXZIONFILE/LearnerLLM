...
**Production hosting:** [backend/CLOUDFLARE_TUNNEL_VPC_DEPLOY.md](backend/CLOUDFLARE_TUNNEL_VPC_DEPLOY.md) (Tunnel + VPC) · [backend/FLY_DEPLOY.md](backend/FLY_DEPLOY.md) (Fly.io) · [workers/CLOUDFLARE_DEPLOY.md](workers/CLOUDFLARE_DEPLOY.md) (Workers + D1).
